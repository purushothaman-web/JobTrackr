...
const Import = () => {
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      const payload = { rows, token: user.token };
      const data = await importJobs(payload);
  ...
  return (
    <div className="mx-auto grid w-full max-w-7xl gap-6 lg:grid-cols-[1.2fr_1fr] py-8 px-4 sm:px-6">
