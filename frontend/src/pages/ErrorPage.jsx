...
const ErrorPage = ({ message = "A critical system error has occurred." }) => {
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] px-4">
      ...
      >
        ...
        <h1 className="font-heading text-6xl sm:text-7xl font-black text-offwhite tracking-tighter uppercase mb-2">
          Halt<span className="text-red-500">_</span>
        </h1>
        ...
        <div className="font-mono text-zinc-400 text-xs sm:text-sm leading-relaxed mb-10 p-4 border border-red-500/20 bg-red-500/5">
