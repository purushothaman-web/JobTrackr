...
const Jobs = () => {
  ...
  const loadJobs = useCallback(async (page = 1, append = false) => {
    ...
    try {
      ...
      const data = await fetchJobs({
        ...
        limit: 9, // Enforcing strict limits to match next.js grid layout visually
      });

      // To tightly couple with brutalist we don't 'append' infinite scroll but do standard hard pages
      ...
      setPagination({ page: data.page, totalPages: data.totalPages, totalJobs: data.totalJobs || newJobs.length });
      setError('');
    } catch (err) {
  ...
  }, [pagination.page, statusFilter, sortBy, order, searchDebounced, loadJobs]);
    ...
    <div className="w-full">
      <div className="mb-12 border-b border-border pb-8 flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          <div className="flex gap-8 mt-6">
            <div>
              ...
              <p className="font-heading text-3xl font-bold text-offwhite">{pagination.totalJobs || jobs.length}</p>
            </div>
            <div>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <CSVLink data={csvData} filename={"jobtrackr_export.csv"} className="focus:outline-none focus:ring-2 focus:ring-electric focus:ring-offset-2 focus:ring-offset-obsidian outline-none">
          ...
          {showFilters && (
            ...
            >
              <div className="flex justify-between items-center mb-6 pb-4 border-b border-border">
                ...
                <button onClick={() => setShowFilters(false)} className="text-zinc-500 hover:text-offwhite transition-colors focus:outline-none">
              ...
              <div className="space-y-6">
                ...
                <div className="pt-6 mt-6 border-t border-border">
                  <Button variant="danger" className="w-full" onClick={clearFilter}>
                    Clear Parameters
                  </Button>
                </div>
              </div>
          ...
          {loading && jobs.length === 0 ? (
            ...
            <>
              ...
              {pagination.totalPages > 1 && (
                <div className="mt-12 flex flex-col md:flex-row gap-4 justify-between items-center bg-obsidian border border-border p-4">
                  <Button 
                    variant="secondary" 
